...
El entregable final es el notebook [MVP_Triaje_Fraude.ipynb](MVP_Triaje_Fraude.ipynb), que implementa un modelo híbrido de detección de fraude (Stacking):
...
1. Abrir [MVP_Triaje_Fraude.ipynb](MVP_Triaje_Fraude.ipynb) en Colab.
